      ...
      <div className="relative min-h-screen bg-black text-text-primary flex flex-col">
        ...
        <div className="relative z-10 flex-1 p-2 lg:p-4 flex items-center justify-center">
          <div className="w-full max-w-7xl h-[calc(100vh-60px)]">
            ...
            <div className="relative bg-black/90 backdrop-blur-sm rounded-2xl overflow-hidden border-4 border-gold/40
                          shadow-[inset_0_4px_12px_rgba(0,0,0,0.9),inset_0_-4px_12px_rgba(0,0,0,0.7),inset_0_0_0_2px_rgba(147,113,39,0.5),0_0_40px_rgba(147,113,39,0.3)] p-1 h-full">
              {/* Console Frame/Bezel */}
              <div className="bg-gradient-to-br from-black/90 via-black/70 to-black/90 rounded-xl overflow-hidden border-2 border-gold/30
                            shadow-[inset_0_3px_8px_rgba(0,0,0,0.9),inset_0_-3px_8px_rgba(0,0,0,0.7),inset_0_0_0_2px_rgba(147,113,39,0.4)] h-full flex flex-col">
                
                {/* Top Control Panel - Navbar */}
                <div className="bg-black/50 backdrop-blur-sm border-b-3 border-gold/50
                              shadow-[inset_0_2px_4px_rgba(0,0,0,0.8),inset_0_-2px_4px_rgba(0,0,0,0.6),0_2px_4px_rgba(0,0,0,0.4),inset_0_-2px_0_rgba(147,113,39,0.6)]">
                  <ConsoleNavbar />
                </div>
                ...
                <div className="flex flex-1">
                  ...
                  <div className="w-56 bg-black/30 backdrop-blur-sm flex flex-col relative border-r-3 border-gold/50
                                shadow-[inset_2px_0_4px_rgba(0,0,0,0.8),inset_-2px_0_4px_rgba(0,0,0,0.6),2px_0_4px_rgba(0,0,0,0.4),inset_2px_0_0_rgba(147,113,39,0.5)]">
                    ...
                    <div className="flex-1 p-2 border-t-3 border-gold/50 shadow-[inset_0_2px_4px_rgba(0,0,0,0.8),0_-2px_4px_rgba(0,0,0,0.6),inset_0_2px_0_rgba(147,113,39,0.5)]">
                      <ConsoleTestimonials />
                    </div>
                  </div>
                  ...
                  <div className="flex-1 relative">
                    ...
                    <div className="absolute inset-2 bg-black/80 rounded-xl border-4 border-gold/60
                                  shadow-[inset_0_4px_12px_rgba(0,0,0,0.95),inset_0_-4px_12px_rgba(0,0,0,0.8),inset_0_0_0_3px_rgba(147,113,39,0.7),0_6px_12px_rgba(0,0,0,0.7)]">
                  ...
                  <div className="w-20 bg-black/30 backdrop-blur-sm flex flex-col border-l-3 border-gold/50
                                shadow-[inset_-2px_0_4px_rgba(0,0,0,0.8),inset_2px_0_4px_rgba(0,0,0,0.6),-2px_0_4px_rgba(0,0,0,0.4),inset_-2px_0_0_rgba(147,113,39,0.5)]">
                    ...
                    <div className="p-2 space-y-2 border-t-3 border-gold/50 shadow-[inset_0_2px_4px_rgba(0,0,0,0.8),0_-2px_4px_rgba(0,0,0,0.6),inset_0_2px_0_rgba(147,113,39,0.5)]">
                ...
                <div className="bg-black/60 backdrop-blur-sm p-2 border-t-3 border-gold/60
                              shadow-[inset_0_3px_6px_rgba(0,0,0,0.8),inset_0_-3px_6px_rgba(0,0,0,0.6),0_-3px_6px_rgba(0,0,0,0.4),inset_0_2px_0_rgba(147,113,39,0.6)]">
                  ...
                  {/* Mobile Footer Info */}
                  <div className="lg:hidden mt-2 pt-2 flex flex-col gap-1 text-xs text-white/60 border-t-3 border-gold/50 shadow-[inset_0_2px_4px_rgba(0,0,0,0.8),0_-2px_4px_rgba(0,0,0,0.6),inset_0_2px_0_rgba(147,113,39,0.5)]">
