...
const ConsoleTestimonials = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-2xl p-3 border border-gold/20 pt-[6px] pb-[6px]" style={{ background: 'rgba(10, 15, 26, 0.6)' }}>
      ...
      <div className="rounded-2xl p-4 border border-gold/30 shadow-inner min-h-[280px] flex flex-col"
