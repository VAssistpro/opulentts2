...
const LuxuryNavbar: React.FC = () => {
  ...
  const handleNavItemClick = (section: string) => { setActiveSection(section); setIsMobileMenuOpen(false); setTimeout(() => {document.getElementById(section)?.scrollIntoView({ behavior: 'smooth', block: 'start' });}, 100); };
