  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="relative z-20 text-center p-4 pb-12 w-full max-w-[906px] mx-auto mt-[17px] mb-[17px]">
        ...
        >
          <div
            className="md:text-3xl lg:text-4xl xl:text-5xl text-white drop-shadow-[0_8px_20px_rgba(0,0,0,1)] [text-shadow:0_0_40px_rgba(0,0,0,0.8),_0_8px_20px_rgba(0,0,0,1)] tracking-tight font-extrabold mt-[4px] mb-[4px] text-[33px]"
          >
            OPULENT{' '}
            <span
