    ...
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="relative z-20 text-center p-4 pb-12 w-full max-w-[906px] mx-auto mt-[38px] mb-[38px]">
        ...
        >
          ...
          <p className="md:text-lg text-white/95 max-w-2xl mx-auto drop-shadow-[0_3px_10px_rgba(0,0,0,1)] [text-shadow:0_0_20px_rgba(0,0,0,0.8),_0_3px_10px_rgba(0,0,0,1)] text-center ml-[86.5px] mr-[86.5px] pl-[9px] pr-[9px] mt-[5px] mb-[5px] pt-[2px] pb-[2px] font-semibold text-[16px]">
          ...
          >
            <div className="space-y-2">
              <p className="text-white/80 text-sm md:text-base max-w-xl mx-auto leading-relaxed mt-[2px] mb-[2px] bg-[#a6a2a200] font-semibold ml-[91.375px] mr-[91.375px] pl-[0px] pr-[0px] text-center">
